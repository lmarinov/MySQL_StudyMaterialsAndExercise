...
public class OfferServiceImpl implements OfferService {
    ...
    public OfferServiceImpl(ModelMapper modelMapper, ValidationUtil validationUtil, XmlParser xmlParser, OfferRepository offerRepository, CarService carService, SellerService service) {
    ...
    public String importOffers() throws IOException, JAXBException {
        ...
        OfferSeedRootDto rootDtos = xmlParser.fromFile(
                OFFERS_FILE_PATH,
                OfferSeedRootDto.class
        );

        rootDtos.getOffers().stream()
                .filter(offerSeedDto -> {
