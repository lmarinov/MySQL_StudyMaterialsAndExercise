...
public class BookServiceImpl implements BookService {
    ...
    public List<String> findAllBookTitlesWithPriceLessThan5OrMoreThan40() {
        return this.bookRepository
                ...
                .stream()
                .map(book -> String.format("%s - $ %2.f", book.getTitle(), book.getPrice()))
                .collect(Collectors.toList());
    }

    @Override
    public List<String> findNotReleasedBookTitlesInYear(Integer year) {
    ...
    @Override
    public List<String> findAllBookTitlesWhereTitleContainsStr(String containsString) {
        return this.bookRepository
                .findByTitleContaining(containsString)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    public int increaseCopiesByDate(LocalDate localDate, int copies) {
        int affectedRows = this.bookRepository.updateCopiesByReleaseDate(copies, localDate);
